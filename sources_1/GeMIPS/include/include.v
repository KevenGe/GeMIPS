...
`define     ALU_OP_NOR      8'b00001010     ///< 按位或非
`define     ALU_OP_XOR      8'b00001100     ///< 按位异或

`define     ALU_OP_SLL      8'b00000100     ///< 逻辑左移
`define     ALU_OP_SRL      8'b00000101    ///< 逻辑右移

`define     ALU_OP_ADD      8'b00000110     ///< 加
`define     ALU_OP_SUB      8'b00000111     ///< 减
`define     ALU_OP_MUL      8'b00001000     ///< 有符号乘法
`define     ALU_OP_DIV      8'b00001001     ///< 除

`define     ALU_OP_LUI      8'b00001011     ///< LUI
`define     ALU_OP_JAR      8'b00001101     ///< JAR
